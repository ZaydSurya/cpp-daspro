    ...
    auto soal2P5 = [](){
        ...
        if(beli == 1){
            if((qty>=3) && (qty<=5)){
                ...
                cout << "Hasil Akhir\t: " << total << endl;
                cout << "---------------------------------------" << endl;
                cout << "Total Belanja kamu adalah " << total << ". SELAMAT! kamu juga mendapatkan BOBA MILK TEA secara gratiss!!!"<< endl;
            } else {
                total = 55000*qty;
                cout << "---------------------------------------" << endl;
                cout << "Nama Barang\t: Kertas PAPER A4 80gram" << endl;
            ...
            if((total>1800000) && (total<5000000)){
                ...
                cout << "---------------------------------------" << endl;
                cout << "Total Belanja kamu adalah " << potongan << ". SELAMAT!! kamu juga mendapatkan 1 MINI BAG secara gratiss!!!"<< endl;
                ...
                cout << "Hasil Akhir\t: " << potongan << endl;
                cout << "---------------------------------------" << endl;
                cout << "Total Belanja kamu adalah " << potongan << ". SELAMAT!! kamu juga mendapatkan 1 REGULER BAG & GANTUNGAN KUNCI secara gratiss!!!"<< endl;
            } else {
                total = 180000*qty;
                cout << "---------------------------------------" << endl;
                cout << "Nama Barang\t: Flashdisk 64GB FLASHDRIVE" << endl;
