...
void kasus1P6(){
    auto soal1P6 = [](){
        ...
        cout << "---------------------------------" << endl;
        cout << "Masukkan Perulangan [Hello World] : "; cin >> n;
        cout << "-----------------------------------" << endl;
        for (int i=0; i<n; i++){
...
void kasus2P6(){
    ...
    auto soal1P6 = [&](){
        do {
            ...
            cout << "---------------------------------" << endl;
            cout << "Input a [Nilai Awal]\t: "; cin >> a;
            cout << "Input n [Nilai Deret]\t: "; cin >> n;
            cout << "---------------------------------" << endl;
            for (int i=a; i<=n; i++){
                cout << i << " ";
            }
...
int pilihan;
    auto soal1P6 = [&](){
        ...
        cout << "----------------------------" << endl;
        for (int i=1; i<=5; i++){
            cout << "Input bilangan ke-" << i << " : "; cin >> a;
            sum = sum + a;
        }
    ...
    cout << "Pilih studi kasus : "; cin >> pilihan;
    switch (pilihan){
        case 1 :
            soal1P6();
            break;
...
void sistemP6(){
    ...
    cout << "3. Modifikasi Input Deret Matematika\n" << endl;
